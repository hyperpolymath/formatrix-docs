...
Replace all {{PLACEHOLDER}} values with your information:
  Formatrix Docs     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  formatrix-docs             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/formatrix-docs/security/advisories/new)
...
- This repository (`hyperpolymath/formatrix-docs`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/formatrix-docs/security/advisories)
...
When using Formatrix Docs, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/formatrix-docs/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/formatrix-docs/security/advisories/new) or 6759885+hyperpolymath@users.noreply.github.com |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/formatrix-docs/discussions) |
...
*Thank you for helping keep Formatrix Docs and its users safe.* 🛡️
