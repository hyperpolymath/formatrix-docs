{
  description = "formatrix-docs - {project-description}";
      ...
      in
      {
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P formatrix-docs.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/formatrix-docs $out/bin/  # Rust
            # cp bin/formatrix-docs $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/formatrix-docs";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-formatrix-docs" {
